...
{
    var endpoint = new Uri("https://tradingpartnerhub01.services.ai.azure.com/api/projects/tradingpartnermainproject");
    AIProjectClient projectClient = new(endpoint, new DefaultAzureCredential());

    PersistentAgentsClient agentsClient = projectClient.GetPersistentAgentsClient();

    PersistentAgent agent = agentsClient.Administration.GetAgent("asst_10yqzr2tsaUhS6utdu5ZolbJ");
